  ...
  return (
    <div className="md:flex lg:space-x-28   lg:px-24">
      <div className="lg:px-4 px-5">
        <h1 className="md:text-7xl text-4xl text-center md:text-start font-semibold lg:mt-40">Recent Movie Series release by"<span className="text-red-600">NETFLIX</span>"</h1>
